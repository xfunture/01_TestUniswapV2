...
const App = () => {
  ...
  const JsonRpcProvider = new ethers.JsonRpcProvider(alchemyKey);
  const chainId = ChainId.MUMBAI as number;

  //**** transaction settings */
  const addrFactory: string = "0x7900309d0b1c8D3d665Ae40e712E8ba4FC4F5453"; // dmm factory contract on mumbai
  const addrTokenA: string = "0x001b3b4d0f3714ca98ba10f6042daebf0b1b7b6f"; // dai on mumbai
  const addrTokenB: string = "0x2058a9d7613eee744279e3856ef0eada5fcbaa7e"; // usdc on mumbai
